...
public class Game {
	...
	private void setUp2Player(Player p1, Player p2) {
		...
		for (int i = 0; i < dimensions; i++) {
			...
			if (i == 0) {
				Piece tPiece = new Piece(0, true, new Posn(0, 0), p1);
				Piece p2Piece = new Piece(numTerraces - 1, false, new Posn(i, dimensions - 1), p2);
				p1.addPiece(tPiece);
				p2.addPiece(p2Piece);
				...
				Piece tPiece = new Piece(0, true, new Posn(dimensions - 1, dimensions - 1), p2);
				Piece p1Piece = new Piece(i / 2, false, new Posn(i, 0), p1);
				p1.addPiece(p1Piece);
				p2.addPiece(tPiece);
				...
				Piece p1Piece = new Piece(i / 2, false, new Posn(i, 0), p1);
				Piece p2Piece = new Piece(numTerraces - (i / 2) - 1, false, new Posn(i, dimensions - 1), p2);
				p1.addPiece(p1Piece);
				p2.addPiece(p2Piece);
			...
			Piece p1Piece = new Piece(numTerraces - (i / 2) - 1, false, new Posn(i, 1), p1);
			Piece p2Piece = new Piece(i / 2, false, new Posn(i, dimensions  - 2), p2);
			p1.addPiece(p1Piece);
			p2.addPiece(p2Piece);
	...
	private void setUp4Player(Player p1, Player p2, Player p3, Player p4) {
		...
		for (int i = 1; i < dimensions - 1; i++) {
			if (i == 1) {
				Piece t1Piece = new Piece(0, true, new Posn(1, 0), p1);
				Piece t2Piece = new Piece(0, true, new Posn(0, 1), p2);
				Piece p3Piece = new Piece(numTerraces - (i / 2) - 1, false, new Posn(i, dimensions -1), p3);
				Piece p4Piece = new Piece(numTerraces - (i / 2) - 1, false, new Posn(dimensions -1, i), p4);
				p1.addPiece(t1Piece);
				p2.addPiece(t2Piece);
				p3.addPiece(p3Piece);
				p4.addPiece(p4Piece);
				...
				Piece p1Piece = new Piece(i / 2, false, new Posn(i, 0), p1);
				Piece p2Piece = new Piece(i / 2, false, new Posn(0, i), p2);
				Piece t3Piece = new Piece(0, true, new Posn(i, dimensions - 1), p3);
				Piece t4Piece = new Piece(0, true, new Posn(dimensions - 1, i), p4);
				p1.addPiece(p1Piece);
				p2.addPiece(p2Piece);
				p3.addPiece(t3Piece);
				p4.addPiece(t4Piece);
